# Prototype Bosses — R1–R3

Per-map boss detail for all 8 prototype bosses. Companion to [scope.md](scope.md) (overview) and [rewards.md](rewards.md) (objective payouts).
